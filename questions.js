questions = [
    {
        question: "Who is the first president of SA?",
        options: [
            { id: 'o1', option: 'Jacob Zuma', isCorrect: false },
            { id: 'o2', option: 'Julius Malema', isCorrect: false },
            { id: 'o3', option: 'Thabo Mbeki', isCorrect: true },
            { id: 'o4', option: 'Helen Zihle', isCorrect: false },
        ]
    },
    {
    ...
    {
        question: "What's the best football team in south africa",
        options: [
            { id: 'o1', option: 'Chiefs', isCorrect: false },
            { id: 'o2', option: 'Sundowns', isCorrect: false },
            { id: 'o3', option: 'Pirate', isCorrect: true },
